...
HD_PWD='/home/henry/Repos/CT-ECE5727-SP21/Lab3/Vivado/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tbird.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tbird.tcl
